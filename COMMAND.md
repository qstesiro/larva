...
&emsp;&emsp;&emsp;&emsp; command, alias<br>
&emsp;&emsp;&emsp;&emsp; command 子表达式，运算结果必须为字符串，某个已经定义的命令不能是某个别名;<br>
&emsp;&emsp;&emsp;&emsp; alias 自定义的别名，子表达式运算结果必须是字符串类型;<br>
