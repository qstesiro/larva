...
public class BreakpointModifyEvent extends Event<ModificationWatchpointEvent> {

    public BreakpointModifyEvent(com.sun.jdi.event.ModificationWatchpointEvent event) {
        super(event);
    }
