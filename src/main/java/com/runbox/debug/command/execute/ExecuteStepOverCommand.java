...
public class ExecuteStepOverCommand extends ExecuteStepCommand {

    public ExecuteStepOverCommand(String command) throws Exception {
        super(command);
    }	
    ...
    public boolean execute() throws Exception {
        if (null != ContextManager.instance().current()) {
            ...
            if (null != request) {										
                if (StepRequest.STEP_MIN != request.size() || StepRequest.STEP_OVER != request.depth()) {
